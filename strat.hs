...
lookupWits (a,b) = [(a, b, i, prefs, prefs', sigma) | (p, q, i, prefs, prefs', sigma) <- wits, ("R" ++ show a, "R" ++ show b) == (p,q)]

wits' = map (\(a,b,_) -> lookupWits (a,b)) (concat xs)
wits'' = concat (map (take 1) wits')

main = mapM_ putStrLn ["R" ++ show i ++ "_R" ++ show j ++ ".strategyproofness(" ++ show k ++ ")" | (i,j,Just k) <- concat xs]

formatPrefs = intercalate "," . map (\xs -> case xs of [x] -> x; _ -> "\\{" ++ intercalate "," xs ++ "\\}") . map sort
formatPrefs' = intercalate "," . map (\xs -> case xs of [x] -> x; _ -> "{" ++ intercalate "," xs ++ "}") . map sort

rotations :: [a] -> [[a]]
rotations xs = [rotate n xs | n <- [0..length xs - 1]]
  where rotate n xs = case splitAt n xs of (ys, zs) -> zs ++ ys

cycles :: Ord a => [(a,a)] -> [[a]]
cycles [] = []
cycles ((x,y) : xs) = 
    let cs = minimum (rotations (x : go y))
    in  cs : cycles [(a,b) | (a,b) <- xs, a `notElem` cs]
  where go y = 
          case lookup y xs of
            Just z -> y : go z
            Nothing -> []

formatPerm :: [(String,String)] -> String
formatPerm = concatMap (\xs -> "(" ++ intercalate "\\ " xs ++ ")") . sort . cycles

main'' =
  mapM_ putStrLn ["\\eqref{S_" ++ show a ++ "_" ++ show b ++ "} & " ++ drop 1 i ++ " & $" ++ formatPrefs prefs ++ "$ & $" ++ formatPrefs prefs' ++ "$ & $" ++ formatPerm sigma ++ "$\\\\"
                    | (a, b, i, prefs, prefs', sigma) <- wits''']

wits''' =
  [(1,2,"A1",[["c","d"],["a","b"]],[["c","d"],["a"],["b"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (1,19,"A3",[["a"],["b"],["c","d"]],[["a","b"],["c","d"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (2,1,"A2",[["c","d"],["a"],["b"]],[["c","d"],["a","b"]],[("a","a"),("c","c"),("b","b"),("d","d")]),
    (2,38,"A1",[["a","c"],["b","d"]],[["a","c"],["b"],["d"]],[("a","a"),("c","c"),("b","b"),("d","d")]),
    (4,8,"A4",[["d"],["c"],["a","b"]],[["c"],["d"],["a","b"]],[("a","a"),("b","b"),("c","d"),("d","c")]),
    (4,18,"A3",[["c"],["a","b"],["d"]],[["a","b","c"],["d"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (4,47,"A2",[["a","d"],["b","c"]],[["a","d"],["c"],["b"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (5,7,"A3",[["a","c"],["d"],["b"]],[["a"],["c"],["d"],["b"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (5,10,"A4",[["d"],["a","b"],["c"]],[["d","b"],["a"],["c"]],[("c","b"),("d","a"),("a","d"),("b","c")]),
    (5,17,"A3",[["a","c"],["d"],["b"]],[["a","c"],["b","d"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (6,19,"A4",[["d"],["b"],["a"],["c"]],[["b","d"],["a"],["c"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (6,42,"A3",[["a","c"],["b","d"]],[["c"],["a"],["b","d"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (7,43,"A3",[["a"],["c"],["d"],["b"]],[["a"],["d","c"],["b"]],[("a","d"),("b","c"),("c","b"),("d","a")]),
    (8,26,"A3",[["d"],["a","b"],["c"]],[["d"],["b"],["c","a"]],[("a","d"),("b","c"),("c","b"),("d","a")]),
    (9,18,"A2",[["a","d"],["c"],["b"]],[["a","d"],["b","c"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (9,35,"A1",[["a","b"],["c","d"]],[["a"],["b"],["c","d"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (9,40,"A1",[["a","b"],["c","d"]],[["a","b"],["c"],["d"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (10,12,"A3",[["a","c"],["d"],["b"]],[["d","c","a"],["b"]],[("a","d"),("b","c"),("c","b"),("d","a")]),
    (10,15,"A4",[["b","d"],["a"],["c"]],[["d"],["b"],["a"],["c"]],[("a","d"),("b","c"),("c","b"),("d","a")]),
    (10,19,"A4",[["b","d"],["a"],["c"]],[["d","b"],["c","a"]],[("a","d"),("b","c"),("c","b"),("d","a")]),
    (10,36,"A2",[["c","d"],["a","b"]],[["d"],["c"],["b","a"]],[("a","d"),("b","c"),("c","b"),("d","a")]),
    (12,10,"A4",[["a","b","d"],["c"]],[["d","b"],["a"],["c"]],[("c","b"),("d","a"),("a","d"),("b","c")]),
    (12,16,"A3",[["a","c"],["d"],["b"]],[["a"],["c"],["d"],["b"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (12,44,"A2",[["a","b"],["c","d"]],[["a","b"],["d"],["c"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (13,15,"A3",[["b","d"],["a"],["c"]],[["b","d"],["a","c"]],[("a","a"),("c","b"),("b","c"),("d","d")]),
    (13,27,"A4",[["a"],["b"],["d"],["c"]],[["a","b"],["c","d"]],[("a","a"),("c","b"),("b","c"),("d","d")]),
    (14,9,"A4",[["a"],["d"],["c"],["b"]],[["a","d"],["c"],["b"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (14,16,"A2",[["d"],["c"],["a","b"]],[["d","c"],["a","b"]],[("a","a"),("b","b"),("c","d"),("d","c")]),
    (14,34,"A3",[["a","b","c"],["d"]],[["b"],["a","c"],["d"]],[("a","a"),("b","b"),("c","d"),("d","c")]),
    (15,5,"A4",[["a"],["c"],["d"],["b"]],[["a"],["d","c"],["b"]],[("a","d"),("b","c"),("c","b"),("d","a")]),
    (15,7,"A3",[["b","d"],["a"],["c"]],[["d"],["a","b"],["c"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (15,10,"A4",[["a"],["c"],["d"],["b"]],[["c","a"],["d"],["b"]],[("a","d"),("b","c"),("c","b"),("d","a")]),
    (15,13,"A2",[["c","d"],["a","b"]],[["c","d"],["a"],["b"]],[("a","a"),("b","c"),("c","b"),("d","d")]),
    (17,3,"A3",[["a","c"],["b","d"]],[["c"],["a"],["b","d"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (17,5,"A3",[["a","c"],["b","d"]],[["a","c"],["d"],["b"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (17,7,"A3",[["a","c"],["b","d"]],[["a"],["c"],["d"],["b"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (17,11,"A3",[["a","c"],["b","d"]],[["c"],["a"],["b"],["d"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (18,9,"A2",[["a","d"],["b","c"]],[["a","d"],["c"],["b"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (19,1,"A1",[["a","b"],["c","d"]],[["a"],["b"],["c","d"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (19,10,"A4",[["a","c"],["b","d"]],[["c","a"],["d"],["b"]],[("a","d"),("b","c"),("c","b"),("d","a")]),
    (19,27,"A2",[["c","d"],["a","b"]],[["c","d"],["a"],["b"]],[("a","a"),("b","c"),("c","b"),("d","d")]),
    (20,21,"A3",[["a"],["c"],["b","d"]],[["a"],["d","c"],["b"]],[("b","d"),("d","a"),("a","c"),("c","b")]),
    (21,35,"A3",[["c"],["a","b"],["d"]],[["a","b","c"],["d"]],[("a","a"),("d","d"),("c","c"),("b","b")]),
    (22,29,"A3",[["d"],["a","b"],["c"]],[["d","b"],["a"],["c"]],[("a","d"),("c","b"),("d","a"),("b","c")]),
    (22,32,"A4",[["a"],["b"],["c","d"]],[["a","b"],["d"],["c"]],[("a","a"),("c","c"),("d","d"),("b","b")]),
    (23,12,"A3",[["a","c"],["b","d"]],[["a","c"],["d"],["b"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (23,18,"A2",[["c","d"],["a","b"]],[["c"],["d"],["a","b"]],[("a","a"),("b","b"),("c","d"),("d","c")]),
    (23,19,"A4",[["a","b","d"],["c"]],[["b","d"],["a"],["c"]],[("a","a"),("b","b"),("c","c"),("d","d")]),
    (24,34,"A3",[["c"],["a"],["b","d"]],[["c"],["d","a"],["b"]],[("c","b"),("d","a"),("a","d"),("b","c")]),
    (25,26,"A2",[["b","d"],["a"],["c"]],[["b","d"],["a","c"]],[("c","b"),("d","d"),("a","a"),("b","c")]),
    (25,36,"A4",[["a"],["c"],["b","d"]],[["a","c"],["d"],["b"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (26,8,"A4",[["a"],["c"],["b","d"]],[["a"],["d","c"],["b"]],[("b","c"),("d","a"),("a","d"),("c","b")]),
    (27,13,"A3",[["a","c"],["b","d"]],[["a"],["c"],["d"],["b"]],[("a","a"),("b","c"),("c","b"),("d","d")]),
    (27,19,"A2",[["b","d"],["a"],["c"]],[["b","d"],["a","c"]],[("a","a"),("b","c"),("c","b"),("d","d")]),
    (28,32,"A4",[["a"],["c"],["b","d"]],[["a"],["d","c"],["b"]],[("c","b"),("d","a"),("a","d"),("b","c")]),
    (28,39,"A3",[["a"],["b"],["c","d"]],[["a","b"],["d"],["c"]],[("c","b"),("d","d"),("a","a"),("b","c")]),
    (29,39,"A3",[["a"],["b"],["c","d"]],[["b","a"],["d"],["c"]],[("a","d"),("c","b"),("d","a"),("b","c")]),
    (30,21,"A4",[["a","b"],["d"],["c"]],[["a"],["b"],["c","d"]],[("a","a"),("d","d"),("c","c"),("b","b")]),
    (30,41,"A3",[["c"],["a","b"],["d"]],[["a","b","c"],["d"]],[("a","a"),("d","d"),("c","c"),("b","b")]),
    (31,38,"A1",[["b","d"],["a"],["c"]],[["d","b"],["c"],["a"]],[("b","d"),("d","b"),("a","c"),("c","a")]),
    (32,22,"A4",[["a","b"],["d"],["c"]],[["a"],["b"],["c","d"]],[("a","a"),("c","c"),("d","d"),("b","b")]),
    (32,28,"A3",[["d"],["a","b"],["c"]],[["d"],["b"],["c","a"]],[("a","d"),("c","b"),("d","a"),("b","c")]),
    (33,5,"A3",[["a"],["b"],["c","d"]],[["a","b"],["c","d"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (33,22,"A1",[["c","d"],["a","b"]],[["d"],["c"],["a","b"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (34,24,"A3",[["b"],["a","d"],["c"]],[["b"],["d"],["c","a"]],[("a","d"),("b","c"),("c","b"),("d","a")]),
    (35,9,"A2",[["a"],["b"],["c","d"]],[["a","b"],["c","d"]],[("a","a"),("d","d"),("c","c"),("b","b")]),
    (35,21,"A3",[["a","b","c"],["d"]],[["c"],["a","b"],["d"]],[("a","a"),("d","d"),("c","c"),("b","b")]),
    (36,10,"A4",[["a"],["b"],["c","d"]],[["b","a"],["d","c"]],[("c","b"),("d","a"),("a","d"),("b","c")]),
    (36,25,"A2",[["a","c"],["d"],["b"]],[["a"],["c"],["b","d"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (36,39,"A1",[["c","d"],["a","b"]],[["c","d"],["a"],["b"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (37,42,"A3",[["a"],["b"],["c","d"]],[["a"],["b"],["d"],["c"]],[("a","d"),("c","c"),("b","b"),("d","a")]),
    (37,42,"A4",[["c"],["d"],["a","b"]],[["c"],["d"],["b"],["a"]],[("a","c"),("c","d"),("b","a"),("d","b")]),
    (39,2,"A1",[["a","c"],["d"],["b"]],[["a","c"],["b","d"]],[("a","a"),("c","c"),("d","d"),("b","b")]),
    (39,29,"A4",[["c","d"],["a"],["b"]],[["d"],["c"],["b","a"]],[("a","d"),("c","b"),("d","a"),("b","c")]),
    (39,36,"A4",[["c","d"],["a"],["b"]],[["c","d"],["a","b"]],[("a","a"),("c","c"),("d","d"),("b","b")]),
    (41,31,"A3",[["a","b","c"],["d"]],[["b","c"],["a"],["d"]],[("a","a"),("d","c"),("c","d"),("b","b")]),
    (42,3,"A3",[["d"],["b"],["a"],["c"]],[["d"],["a","b"],["c"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (42,11,"A4",[["c"],["a"],["b","d"]],[["c"],["b","a"],["d"]],[("c","d"),("d","c"),("a","b"),("b","a")]),
    (42,24,"A2",[["a","b"],["c","d"]],[["b"],["a"],["c","d"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (44,12,"A3",[["a","b"],["d"],["c"]],[["a","b"],["c","d"]],[("c","c"),("d","d"),("a","a"),("b","b")]),
    (44,40,"A1",[["c","d"],["a","b"]],[["c"],["d"],["a","b"]],[("c","d"),("d","c"),("a","a"),("b","b")]),
    (45,31,"A3",[["a","b"],["c"],["d"]],[["b"],["a"],["d","c"]],[("a","d"),("c","b"),("d","a"),("b","c")]),
    (46,20,"A3",[["a","c"],["b","d"]],[["a"],["c"],["b","d"]],[("b","b"),("d","d"),("a","a"),("c","c")]),
    (46,37,"A1",[["b","d"],["a"],["c"]],[["d","b"],["c","a"]],[("b","c"),("d","a"),("a","d"),("c","b")]),
    (47,30,"A1",[["a","b"],["c","d"]],[["a","b"],["d"],["c"]],[("a","a"),("b","b"),("c","c"),("d","d")])]

graph = "digraph {\n" ++ intercalate "\n" (nodes ++ map mkEdge wits''') ++ "\n}\n"
  where nodes = [show i ++ "[label=<R<SUB>" ++ show i ++ "</SUB>>]" | i <- [1..47]]
        mkEdge (a, b, i, _, prefs, sigma) = show a ++ " -> " ++ show b ++ " [label=\"" ++ i ++ ":=" ++ formatPrefs' prefs ++ "\"]"
